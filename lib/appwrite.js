...
export const uploadFile = async (file,type)=>{
    ...
    let fileName = file.fileName || 'untitled';  // Default filename
    let mimeType = file.mimeType || 'application/octet-stream';  // Default mime type
    let fileSize = file.fileSize;  // Get the file size
